local M = {}
M.init_commands = {"git-status", "filelist", "git-diff-init"}

M.map_table = {}
M.map_table["git-status"] = {winnum=nil, bufnum=nil, command="git status"}
M.map_table["filelist"] = {winnum=nil, bufnum=nil, command="git diff --name-only --cached"}
local file_select_suggestion = "To show git diff of files, " ..
                            "select the file path in the window below, " ..
                            "and press Enter."
M.map_table["git-diff-init"] = {winnum=nil, bufnum=nil, command="echo " .. file_select_suggestion}
