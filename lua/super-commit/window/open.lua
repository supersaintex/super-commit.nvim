...
-- local init_commands = {"git-status", "filelist", "git-diff-init"}
...
function M.setup()
  ...
  vim.cmd('wincmd l')
  vim.cmd('enew')
  Get_win_buf_number(init_commands[3])
  vim.cmd('wincmd h')
  vim.cmd('rightbelow split')
  vim.cmd('wincmd j')
  vim.cmd('enew')
  Get_win_buf_number(init_commands[1])
  vim.cmd('wincmd l')
  vim.cmd('rightbelow split')
  vim.cmd('wincmd j')
  vim.cmd('enew')
  Get_win_buf_number(init_commands[2])
